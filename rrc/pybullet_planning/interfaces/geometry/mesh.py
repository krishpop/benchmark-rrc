...
from rrc.pybullet_planning.utils import TEMP_DIR, PI
from rrc.pybullet_planning.utils import ensure_dir, write, read, safe_zip
...
def create_mesh(mesh, under=True, **kwargs):
    ...
    from rrc.pybullet_planning.interfaces.env_manager.shape_creation import create_obj
    ensure_dir(TEMP_DIR)
...
def grow_polygon(vertices, radius, n=8):
    from rrc.pybullet_planning.interfaces.env_manager.pose_transformation import unit_from_theta
