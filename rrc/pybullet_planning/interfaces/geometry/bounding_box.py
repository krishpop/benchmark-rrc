...
from rrc.pybullet_planning.utils import CLIENT, BASE_LINK, UNKNOWN_FILE, OBJ_MESH_CACHE
...
def get_subtree_aabb(body, root_link=BASE_LINK):
    from rrc.pybullet_planning.interfaces.robots.link import get_link_subtree
