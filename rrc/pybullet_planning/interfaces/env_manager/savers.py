...
from rrc.pybullet_planning.utils import CLIENT, set_client
...
class ConfSaver(Saver):
    def __init__(self, body): #, joints):
        from rrc.pybullet_planning.interfaces.robots.joint import get_configuration
        self.body = body
    ...
    def restore(self):
        from rrc.pybullet_planning.interfaces.robots.joint import set_configuration
...
class PoseSaver(Saver):
    def __init__(self, body):
        from rrc.pybullet_planning.interfaces.robots.body import get_pose, get_velocity
        self.body = body
    ...
    def restore(self):
        from rrc.pybullet_planning.interfaces.robots.body import set_pose, set_velocity
