...
from rrc.pybullet_planning.utils import CLIENT, BASE_LINK
from rrc.pybullet_planning.interfaces.env_manager.pose_transformation import multiply, invert, set_pose, get_pose
from rrc.pybullet_planning.interfaces.robots.link import get_link_subtree, get_link_pose
...
class Attachment(object):
    ...
    @property
    def bodies(self):
        from rrc.pybullet_planning.interfaces.robots.collision import flatten_links
    ...
    def to_data(self):
        from rrc.pybullet_planning.interfaces.robots.body import get_body_name, get_name
    ...
    def from_data(cls, data):
        from rrc.pybullet_planning.interfaces.env_manager.simulation import is_connected
        from rrc.pybullet_planning.interfaces.robots.body import body_from_name
        from rrc.pybullet_planning.interfaces.robots.link import link_from_name
        if not is_connected():
...
def get_grasp_pose(constraint):
    ...
    [type]
        [description]
    """
    from rrc.pybullet_planning.interfaces.task_modeling.constraint import get_constraint_info
