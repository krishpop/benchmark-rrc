...
def wholebody_extend_towards(tree, target, distance_fn, extend_fn, collision_fn,
    ...
    import functools
    import numpy as np
    from rrc.pybullet_planning.interfaces.kinematics.ik_utils import sample_multiple_ik_with_collision, sample_no_collision_ik
...
def rrt_goal_sample(goal_test, end_pose, goal_threshold, ori_matters):
    ...
    from rrc.pybullet_planning.motion_planners.utils import weighted_position_error
...
def _rrt(q1, goal_sample_fn, goal_test, distance_fn, sample_fn,
    ...
    """
    import functools
    from rrc.pybullet_planning.interfaces.kinematics.ik_utils import sample_multiple_ik_with_collision
