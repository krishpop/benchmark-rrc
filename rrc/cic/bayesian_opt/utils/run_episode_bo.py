...
from rrc.cic import rotation_primitives

from rrc.cic.bayesian_opt.const import RELATIVE_MOVEMENT, EPISODE_LEN_REAL

from rrc.cic import parameters_new_grasp as cic_parameters_new_grasp
from rrc.cic.states import CICStateMachineLvl4 as CICwithCG
...
def main():
    with open("/ws/src/usercode/rrc/cic/bayesian_opt/content/diff.txt", 'r') as f:
    ...
    with open("/ws/src/usercode/rrc/cic/bayesian_opt/content/params.pkl", 'rb') as f:
    ...
    with open("/ws/src/usercode/rrc/cic/bayesian_opt/content/model.txt", 'r') as f:
